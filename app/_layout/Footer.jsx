        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 28, marginBottom: 32 }}>
          ...
          <div>
            ...
            {[
              ...
              <Link key={l.to} href={l.to} style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,.7)', marginBottom: 7, transition: 'color .15s' }}>
                {l.label}
              </Link>
            ))}
          </div>
          ...
          <div>
            ...
            {[
              ...
              <Link key={l.label} href={l.to} style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,.7)', marginBottom: 7 }}>
                {l.label}
              </Link>
            ))}
          </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,.1)', paddingTop: 20, display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: 16 }}>
            {[
              ...
              <Link key={l.label} href={l.to} style={{ fontSize: 12, color: 'rgba(255,255,255,.45)' }}>
                {l.label}
              </Link>
            ))}
          </div>
