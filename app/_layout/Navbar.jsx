...
import { useCartStore, useAuthStore, useWishlistStore } from '../../src/lib/store'
      ...
      <nav style={{
        ...
        <div style={{display:'flex', gap:8, alignItems:'center', marginLeft:'auto'}}>
          ...
          <div style={{position:'relative'}}>
            <button onClick={() => user ? setUserMenuOpen(!userMenuOpen) : router.push('/login')}
              style={{
            ...
            {userMenuOpen && user && (
              <div style={{
                ...
                {[
                  ...
                  <Link key={item.to} href={item.to} onClick={() => setUserMenuOpen(false)}
