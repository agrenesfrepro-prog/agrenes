      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        {step === 2 && (
          <div style={{ textAlign: 'center', padding: '40px 20px' }}>
            ...
            {!user && (
              <div style={{
                marginTop: 16, background: 'var(--aml)', border: '1px solid #FAC775',
                borderRadius: 14, padding: 18, textAlign: 'center'
              }}>
                <div style={{ fontSize: 20, marginBottom: 8 }}>🎁</div>
                <div style={{ fontSize: 14, fontWeight: 700, marginBottom: 6 }}>Save time next time</div>
                <p style={{ fontSize: 13, color: 'var(--mu)', marginBottom: 14, lineHeight: 1.6 }}>
                  Create a free account to track this order, reorder with one tap, and get exclusive deals.
                </p>
                <button onClick={() => navigate('/login')} className="btn-amber" style={{ width: '100%', justifyContent: 'center', height: 44 }}>
                  Create Free Account →
                </button>
              </div>
            )}
