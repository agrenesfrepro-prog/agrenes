...
function PromoGrid() {
  ...
  const cards = [
    ...
    {color:'amber', bg:'var(--aml)', border:'#FAC775', emoji:'🥦', title:'Fresh Vegetables', sub:'Peppers, tomatoes, cabbage', cat:'vegetables'},
    {color:'purple', bg:'var(--pul)', border:'#C8B5F0', emoji:'🫘', title:'Beans & Nuts', sub:'Red beans, yellow beans, cashews', cat:'legumes'},
    {color:'red', bg:'var(--rdl)', border:'#F4B0B4', emoji:'🌾', title:'Dried Foods', sub:'Cassava, yam, sweet potato', cat:'dried'},
    {color:'green', bg:'var(--gll)', border:'#9FE1CB', emoji:'🧃', title:'Beverages', sub:'Bushera, Stoney, Novida', cat:'all'},
    {color:'amber', bg:'#FFF3E0', border:'#FFCC80', emoji:'🎨', title:'African Crafts', sub:'Wooden art, clay cups, mats', cat:'all'},
  ]
  return (
...
function StatsBanner() {
  ...
  return (
    <div style={{
      background:'var(--g1)', margin:'8px 14px', borderRadius:var(--r),
